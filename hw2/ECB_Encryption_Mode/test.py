...
M1 = 'login=aaaaaaaaaaaaaaaa&role=user&pwd=bbbbbbbbbbb'
C1 = 'f27d8f91d2419abd7b8ed437d88aefbe5a20ef70b02be2ae74373b5a21fe4e531aff28f1838f67aa2941b08f833b9cfc302f9bbb3f80accb3edac2e7dbd1d8e2'
...
if __name__ == '__main__':
    ...
    print m1
    print c1
    # print("Message: {}".format(m1[0] + m1[1] + m1[3]))
